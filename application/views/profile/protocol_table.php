<?php if(isset($details)){
    foreach ($details as $key) {?>
        ...
        <td class="ett_speed" >
            <input type="text" name="stage_speed[]" value="<?php echo $key['speed']; ?>" />        
        </td>
        <td  class="ett_grade" >
        ...
        <td class="ett_hr" ><input type="text" name="stage_hr[]" value="<?php echo $key['hr']; ?>"></td>
        <td class="ett_sbp" ><input type="text" name="stage_sbp[]" value="<?php echo $key['sbp']; ?>"></td>
        <td class="ett_dbp" ><input type="text" name="stage_dbp[]" value="<?php echo $key['dbp']; ?>"></td>
        <td class="ett_protocol_condition" ><input type="text" name="stage_condition[]" value="<?php echo $key['protocol_condition']; ?>"></td>
    </tr>
<?php        
    }
