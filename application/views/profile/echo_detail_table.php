    ...
    <tr>
        ...
        <tbody>
            <?php foreach ($details as $detail): ?>
                <tr>
                    <td style="width: 20px"><a href="javascript:void(0)" class="btn btn-danger btn-xs" onClick="echotestDelete(this,'<?php echo $detail['id']; ?>','<?php echo $detail['patient_id']; ?>');"><i class="fa fa-trash"></i></a></td>
                    <td>
