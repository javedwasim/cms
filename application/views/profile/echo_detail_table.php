        ...
        <tbody>
            <?php foreach ($details as $detail): ?>
                <tr>
                    ...
                    <td style="padding: 0" class="<?php echo in_array("echos-can_edit-0", $permissions)?"op-hide":''; ?>">
                    ...
                    <td style="width: 100px; cursor: pointer;"><?php echo date('Y-m-d',strtotime($detail['created_at'])) ?></td>
