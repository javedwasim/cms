<table class="table table-bordered nowrap responsive item_table" cellspacing="0" id="medicine_item_tbl" width="100%" >
    <thead>
    <tr>
    ...
    <?php foreach ($items as $item): ?>
        <tr class="table-row" id="<?php echo $item['id']; ?>">
            ...
            <td class="medicine_item" onClick="medicineItemEdit(this);">
                <input type="text" class="form-control border-0 bg-transparent shadow-none" name="medicine_item" value="<?php echo $item['name']; ?>" onchange="saveToDatabase(this,'item_name','<?php echo $item['id']; ?>')" />         
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
