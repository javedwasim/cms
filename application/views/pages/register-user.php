<div class="dashboard-content" style="width: 98%;">
                                        ...
                                        <div class="ribbon-wrapper card">
                                            ...
                                            <p class="ribbon-content m-t-10">
                                                <?php foreach ($appointment_rights as $a): $right_name = explode('-',$a); ?>
                                                    <?php if(($right_name[0]=='can_delete') || ($right_name[0]=='can_edit') || ($right_name[0]=='can_add') || ($right_name[0]=='view_wallet') || ($right_name[0]=='mark_status') || ($right_name[0]=='can_complete')){ ?>
...
<div class="modal fade" id="useredit" role="dialog">
    <div class="modal-dialog modal-lg" id="user_moda_contnt">
          <!-- Modal content-->
