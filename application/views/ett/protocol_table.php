...
<table class="table table-bordered nowrap responsive datatables" cellspacing="0" id="ett_protocol_tbl" width="100%" >
   <thead>
        <tr>
        ...
        <tr id="<?php echo $key['id']; ?>">
            ...
            <?php if($loggedin_user['is_admin']==1){ ?>
                <td class="exam_cate" onClick="showExamination(this);">
                    <input type="text" class="form-control border-0 bg-transparent shadow-none"  name="ett_protocol" value="<?php echo $key['protocol']; ?>" onchange="saveToprotocol(this,'protocol','<?php echo $key['id']; ?>')" >        
                </td>
