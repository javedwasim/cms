...
<table class="table table-bordered nowrap responsive datatables" cellspacing="0" id="ending_reasons_tbl" width="100%" >
    <thead>
        <tr>
        ...
        <tr id="<?php echo $key['id']; ?>">
            ...
            <?php if($loggedin_user['is_admin']==1){ ?>
                <td class="exam_cate" onClick="showExamination(this);">
                    <input type="text" class="form-control border-0 bg-transparent shadow-none" name="ending_reason" value="<?php echo $key['ending_reason'] ?>" onchange="saveToendingreason(this,'ending_reason','<?php echo $key['id']; ?>')">        
                </td>
