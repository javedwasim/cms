...
<body class="A4 " >
    <section class="sheet padding-10mm">
        ...
        <table class="tg" style="display: -webkit-box;margin: 0 auto;">
            <thead>
                 <tr>
                   <th class="tg-yw4l dark">ID</th>
                   <th class="tg-yw4l dark">Name</th>
                   <th class="tg-yw4l dark">Father/Husband</th>
                   <th class="tg-yw4l dark">Contact</th>
                   <th class="tg-yw4l dark">Profession</th>
                   <th class="tg-yw4l dark">District</th>
                 </tr>
             </thead>
             <tbody>
                <tr>
                   <td class="tg-yw4l"></td>
                   <td class="tg-yw4l" style="text-transform: capitalize;"></td>
                   <td class="tg-yw4l"></td>
                   <td class="tg-yw4l"></td>
                   <td class="tg-yw4l"></td>
                   <td class="tg-yw4l"></td>
